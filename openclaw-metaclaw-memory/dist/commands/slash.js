 ...
 */
export function registerSlashCommands(api, getClient, config) {
    ...
    api.registerCommand({
        ...
        handler: async (ctx) => {
            ...
            try {
                ...
                const lines = results.map((r, i) => `[${i + 1}] ${r.unit.summary || r.unit.content.slice(0, 120)} (score: ${r.score.toFixed(3)})`);
